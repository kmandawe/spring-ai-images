...
import com.kensbunker.springaifunctions.functions.StockQuoteFunction;
import com.kensbunker.springaifunctions.functions.WeatherServiceFunction;
import com.kensbunker.springaifunctions.model.Answer;
import com.kensbunker.springaifunctions.model.Question;
import com.kensbunker.springaifunctions.model.StockPriceRequest;
import com.kensbunker.springaifunctions.model.StockPriceResponse;
import com.kensbunker.springaifunctions.model.WeatherRequest;
import com.kensbunker.springaifunctions.model.WeatherResponse;
...
public class OpenAIServiceImpl implements OpenAIService {
  ...
  public Answer getStockPrice(Question question) {
                ...
                List.of(
                    FunctionCallback.builder()
                        ...
                        .responseConverter(
                            (response) -> {
                              String schema =
                                  ModelOptionsUtils.getJsonSchema(StockPriceResponse.class, false);
    ...
    var response =
        openAiChatModel.call(new Prompt(List.of(userMessage, systemMessage), promptOptions));
                ...
                List.of(
                    FunctionCallback.builder()
                        ...
                        .responseConverter(
                            response -> {
                              String schema =
                                  ModelOptionsUtils.getJsonSchema(WeatherResponse.class, false);
                              String json = ModelOptionsUtils.toJsonString(response);
                              return schema + "\n" + json;
                            })
                        .build()))
